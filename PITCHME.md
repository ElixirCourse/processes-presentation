...
* Като цяло това е приоритетна опашка от Elixir процеси и портове. <!-- .element: class="fragment" -->
* Това значи че ако имаме четири Scheduler-а, е възможно да имаме четири паралелни Elixir-level. <!-- .element: class="fragment" -->
